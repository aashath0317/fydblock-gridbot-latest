...
class GridLevel:
    def __init__(self, price: float, state: GridCycleState, stock_on_hand: float = 0.0, order_quantity: float = 0.0):
        ...
        self.order_quantity: float = order_quantity  # Fixed order size for this grid level
